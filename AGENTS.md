...
This project is indexed by GitNexus as **git-client-design** (4207 symbols, 10075 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
