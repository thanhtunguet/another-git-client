...
This project is indexed by GitNexus as **git-client-design** (3597 symbols, 8843 relationships, 291 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
