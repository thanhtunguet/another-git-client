...
## 2026-08-15
- Fixed integrated terminal font rendering and letter spacing by resolving system monospace font stack in xterm options and setting default letter spacing (`letterSpacing: 0`). See `docs/changelogs/2026-08-15_terminal_font_spacing.md`.
