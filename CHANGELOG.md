...
- Optimized the Compare view to fill available horizontal space: side-by-side commit panes are
  evenly split, commit messages receive the remaining row width, and the comparison graph resizes
  with its viewport. See
