...
This project is indexed by GitNexus as **git-client-design** (4050 symbols, 9115 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
