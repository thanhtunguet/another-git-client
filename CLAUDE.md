...
This project is indexed by GitNexus as **git-client-design** (1054 symbols, 2640 relationships, 89 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
